...
output_excel_file = os.path.join(base_dir, '/app/abstract_version/Outputs_Abstract/site_filter.xlsx')
site_json_file = os.path.join(base_dir, '/app/abstract_version/Outputs_Abstract/pmid_results.json')
output_json = os.path.join(base_dir, '/app/abstract_version/Outputs_Abstract/filtered_pmid_results.json')
