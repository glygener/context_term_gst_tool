...
json_file_path = os.path.join(base_dir, '/app/full_length_version/Outputs_FL/filtered_pmid_results.json')
excel_file_path = os.path.join(base_dir, '/app/full_length_version/Outputs_FL/sentences.xlsx')
updated_json_file_path = os.path.join(base_dir, '/app/full_length_version/Outputs_FL/modified_pmid_results.json')
