...
if __name__ == "__main__":
    ...
    #pmidFile = sys.argv[1]
    text_folder = os.path.join(base_dir, '/app/full_length_version/output_text_section_FL')
    sentence_file = os.path.join(base_dir, '/app/full_length_version/Outputs_FL/sentences.xlsx')

    json_file_path = os.path.join(base_dir, '/app/full_length_version/Outputs_FL/pmid_results.json')
