...
if __name__ == "__main__":
    ...
    pc_ids_file = os.path.join(base_dir, '/app/full_length_version/Outputs_FL/pmids_pmcids.xlsx')  # Replace with the path to your file containing PC IDs
    output_dir = os.path.join(base_dir, '/app/full_length_version/bioc_xml_fl')  # Replace with your desired output directory
