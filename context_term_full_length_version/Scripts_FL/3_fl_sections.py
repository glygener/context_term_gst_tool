...
input_dir = os.path.join(base_dir, '/app/full_length_version/bioc_xml_fl')
output_xml_dir = os.path.join(base_dir, '/app/full_length_version/output_xml_section_FL')
output_text_dir = os.path.join(base_dir, '/app/full_length_version/output_text_section_FL')
