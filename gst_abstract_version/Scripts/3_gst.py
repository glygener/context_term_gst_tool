...
output_file = os.path.join(base_dir, '/app/gst_abstract/Outputs/output_predictions1.csv') 
...
final_output_file = os.path.join(base_dir, '/app/gst_abstract/Outputs/final_gst.xlsx')
