...
model_path = os.path.join(base_dir, '/app/gst_abstract/Saved_Model')
...
# Define file paths
input_excel_file = os.path.join(base_dir, '/app/gst_abstract/Outputs/sentences.xlsx')  # Input file with sentences
output_csv_file = os.path.join(base_dir, '/app/gst_abstract/Outputs/output_predictions.csv')  # Output file with predictions
