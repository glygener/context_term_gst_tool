...
spreadsheet_path = os.path.join(base_dir, '/app/gst_full/Outputs/pmids_pmcids.xlsx')
missing_articles_path = os.path.join(base_dir, '/app/gst_full/Outputs/missing_full_length_pmids.txt')
