...
file_path = os.path.join(base_dir, '/app/gst_full/Outputs/output_predictions.csv') 
...
output_file_path = os.path.join(base_dir, '/app/gst_full/Outputs/output_predictions1.csv') 
